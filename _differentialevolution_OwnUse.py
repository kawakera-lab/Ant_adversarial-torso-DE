...
class DifferentialEvolutionSolver:
    ...
    def solve(self):
        ...
        col = ["hip4", "ankle4", "hip1","ankle1","hip2","ankle2","hip3","ankle3"]
        df2 = pd.DataFrame(self.population+0.5)
        #df2 = pd.DataFrame(self.population*0.8+0.6, columns=col)
        df2.to_csv('~/save destination/attack_parameter.csv',index=False)
