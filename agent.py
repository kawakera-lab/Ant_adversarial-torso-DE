...
class Agent:
    ...
    def save_weights(self, iteration, state_rms):
        torch.save({"current_policy_state_dict": self.current_policy.state_dict(),
                    ...
                    "state_rms_count": state_rms.count}, "./save destination/"+self.env_name + str(iteration)+ "_weights.pth")
    ...
    def load_weights(self):
        ...
        checkpoint = torch.load("./save destination/"+self.env_name + "1000_weights.pth") 
